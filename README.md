...
The Smart Crop Recommendation System is a rule-based expert system developed in Python, originally implemented in Prolog, designed to help farmers choose the most suitable crop based on environmental conditions.
...
Future enhancements using this system involve using machine learning models, adding a GUI or web application, weather API integration, fertilizer recommendation and disease prediction module.
Technology used: Python IDLE, GitHub
